...
//  println(validatedf.count())
  //println(ssw.join(validatedf1 , Seq("TRANS_ID_PLUS"), "inner").select("TRANS_ID_PLUS").count())
//  validatedf1.filter(col("TRANS_ID").like("%AL4147333%")).show()
//  ssw.filter(col("TRANS_ID")=== "%JP4208831%").show()

//  validatedf1.filter(col("TRANS_ID_PLUS")==="JP42088311004586COD1").show()
//  ssw.filter(col("TRANS_ID_PLUS")==="JP42088311004586COD1").show()
