...
object shw extends App {
  ...
  val ctmrza1 = df.groupBy("COMPONENT_ID_COMPONENT","BRAND_CODE_COMPONENT","TYPE_COMPONENT","MODEL_COMPONENT","CATEGORY_COMPONENT","UPGRADE_FLAG_COMPONENT", "LIST_PRICE_LOCAL_COMPONENT",     "COUNTRY_CODE_QUOTE","QUOTE_ID_QUOTE","CHANNELIDCODE_QUOTE","APPROVAL_CODE_QUOTE","COPRA_APPROVED_INDICATOR_QUOTE","BP_QUOTE_STATUS_QUOTE","BP_REASON_CODE_QUOTE","CREATOR_TYPE_QUOTE",
    ...
    .withColumn("CAL_QUARTER",concat(lit("Q"),quarter(col("CAL_QUARTER")), year(col("CAL_QUARTER"))))
    .withColumn("ROLLOUT_QUARTER",concat(lit("Q"),quarter(col("ROLLOUT_QUARTER")), year(col("ROLLOUT_QUARTER"))))
    ...
    .withColumn("LIST_PRICE",col("LIST_PRICE"))
    .withColumn("DISCOUNT",col("BID_REVENUE")-col("LIST_PRICE"))
...
//  val df1  =ctmrza1.groupBy("TRANS_ID")
//    .agg(
//      max("BELOWDELEGCODE").as("BELOWDELEGCODE"),
//      sum("BID_REVENUE").as("BID_REVENUE"),
//      sum("LIST_PRICE").as("LIST_PRICE")
//    )
//  val ctmrza2=df1.filter(
//    (col("BELOWDELEGCODE").isin("E","N"))
//      && (col("BID_REVENUE") < 10000000)
//      && (col("LIST_PRICE") =!= col("BID_REVENUE"))
//  )
//  var newctmrza2 = ctmrza2
//  for(col <- ctmrza2.columns){
//    newctmrza2 = newctmrza2.withColumnRenamed(col,col.concat("_ZA2"))
//  }
//  val iwrxs70 = ctmrza1.join(newctmrza2, ctmrza1("TRANS_ID")===newctmrza2("TRANS_ID_ZA2")).groupBy(
//    "APPROVALCODE", "TRANSACTIONSTATUS", "CURRENCYCODE", "CONVERSIONCODE", "COSTCONVERSRATE",
//    "GEOCODE", "GEODESC", "REGIONCODE", "REGIONDESC", "IS0_2_CTRY_CODE", "COUNTRYDESC", "TRANS_ID_PLUS",
//    "TRANS_ID", "TPRSS_BMDIV", "PROD_TYPE", "PRODID", "MACHINE_TYPE", "MACHINE_MODEL", "CHANNEL_ID", "DIRECT_FL",
//    "TRANS_DT", "CREATE_DATE", "QUOTE_DATE", "APPROVE_DATE", "SIGNED_DATE", "CALYEAR", "CAL_QUARTER", "ROLLOUT_YEAR",
//    "ROLLOUT_QUARTER", "CUSTOMER_NUM", "CUSTOMER_NAME", "COVERAGE_TYPE", "COVERAGE_ID", "COVERAGE_NAME",
//    "ISU", "CITY", "REGIONSTATE", "ZIPCODE",  "QUANTITY", "LIST_PRICE", "REQUESTED_PRICE",
//    "DISCOUNT", "BID_REVENUE", "BMC", "TMC", "BMC_GP", "TMC_GP", "MES_FL", "BM_RECORD_FL", "DELEG_FL","BELOWDELEGCODE"
//  )
//    .agg(
//      sum("QUANTITY").as("QUANTITY"),
//      sum("LIST_PRICE").as("LIST_PRICE"),
//      sum("REQUESTED_PRICE").as("REQUESTED_PRICE"),
//      sum("DISCOUNT").as("DISCOUNT"),
//      sum("BID_REVENUE").as("BID_REVENUE"),
//      sum("BMC").as("BMC"),
//      sum("TMC").as("TMC"),
//      sum(".BMC_GP").as(".BMC_GP"),
//      sum("TMC_GP").as("TMC_GP"),
//
//    )
//val iwrxs70 = ctmrza1.join(newctmrza2, ctmrza1("TRANS_ID")===newctmrza2("TRANS_ID_ZA2")).groupBy(
//  "APPROVALCODE", "TRANSACTIONSTATUS", "CURRENCYCODE", "CONVERSIONCODE", "COSTCONVERSRATE",
...
//  "TRANS_DT", "CREATE_DATE", "QUOTE_DATE", "APPROVE_DATE", "SIGNED_DATE", "CALYEAR", "CAL_QUARTER", "ROLLOUT_YEAR",
//  "ROLLOUT_QUARTER", "CUSTOMER_NUM", "CUSTOMER_NAME", "COVERAGE_TYPE", "COVERAGE_ID", "COVERAGE_NAME",
//  "ISU", "CITY", "REGIONSTATE", "ZIPCODE", "MES_FL", "BM_RECORD_FL", "DELEG_FL","BELOWDELEGCODE"
//)
//  .agg(
//    sum("QUANTITY").as("QUANTITY"),
//    sum("LIST_PRICE").as("LIST_PRICE"),
